...
class SampleApp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.frames = {}
        for F in (StartPage, PageOne, PageTwo, PageTree):
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button3 = tk.Button(self, text="Go to Graph page",
...
class PageTree(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        teacher1 = teacher[teacher['Anomaly'] == True]

        fig = Figure()
        fn = fig.add_subplot(111)
        fn.plot(teacher['DateTime'], teacher['Energy'], color='b', label="Normal")
        fn.plot(teacher1['DateTime'], teacher1['Energy'], color='r', label="Anomaly")
